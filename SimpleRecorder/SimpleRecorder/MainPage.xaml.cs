...
namespace SimpleRecorder
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            _compositionGraphicsDevice = Microsoft.Graphics.Canvas.UI.Composition.CanvasComposition.CreateCompositionGraphicsDevice(
            ...
            _surface = _compositionGraphicsDevice.CreateDrawingSurface(
                ...
                Windows.Graphics.DirectX.DirectXAlphaMode.Premultiplied);    // This is the only value that currently works with
            ...
            visual.Brush = brush;
            Windows.UI.Xaml.Hosting.ElementCompositionPreview.SetElementChildVisual(this.CanvasContainer, visual);
        }
        ...
        private Microsoft.Graphics.Canvas.CanvasDevice _device;

        private Encoder _encoder;

        private Windows.UI.Composition.CompositionGraphicsDevice _compositionGraphicsDevice;
